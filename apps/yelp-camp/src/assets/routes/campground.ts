...
router.route('/')
    ...
    .post(validateCampground, isLogedin, catchAsync(Campgrounds.craeateCampground));
...
router.route('/:id')
    ...
    .put(validateCampground, isLogedin, isAuthor, catchAsync(Campgrounds.updateCampground))
